...
public class PendingModel {
    ...
    public double TotalAssignmentAmount;

    @SerializedName("details")
    public ArrayList<PendingDetailsModel> pendingDetailsModels;
    ...
    public ArrayList<ShortIssuanceModel> shortIssuanceModelArrayList;

    public ArrayList<ShortIssuanceModel> getShortIssuanceModelArrayList() {
        return shortIssuanceModelArrayList;
    }

    public void setShortIssuanceModelArrayList(ArrayList<ShortIssuanceModel> shortIssuanceModelArrayList) {
        this.shortIssuanceModelArrayList = shortIssuanceModelArrayList;
    }
    ...
    public ArrayList<PendingDetailsModel> getPendingDetailsModels() {
        return pendingDetailsModels;
    }

    public void setPendingDetailsModels(ArrayList<PendingDetailsModel> pendingDetailsModels) {
