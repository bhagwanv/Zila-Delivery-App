package com.zila.storelastmile.barcode;
...
import com.zila.storelastmile.barcode.camera.CameraSource;
import com.zila.storelastmile.barcode.camera.CameraSourcePreview;
import com.zila.storelastmile.barcode.camera.GraphicOverlay;
...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.CAMERA)) {
                ...
                builder.setMessage("Camera permission required for scanning BarCode");
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity(), R.string.error_invalid_quantity_required, Toast.LENGTH_LONG).show();
                Log.w(TAG, getString(R.string.error_invalid_quantity_required));
            }
        }
