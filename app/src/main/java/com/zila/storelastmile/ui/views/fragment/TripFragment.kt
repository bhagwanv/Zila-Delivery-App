...
import com.zila.storelastmile.databinding.FragmentTripBinding
import com.zila.storelastmile.listener.LisnerAllTrip
import com.zila.storelastmile.ui.views.adapter.AllTripAdapter
import com.zila.storelastmile.ui.views.main.LoginActivity
import com.zila.storelastmile.ui.views.main.MainActivity
import com.zila.storelastmile.ui.views.viewmodels.AllTripViewModel
import com.zila.storelastmile.utilities.*
import com.zila.storelastmile.viewfactory.AllTripFactory
...
class TripFragment : Fragment(), LisnerAllTrip {
    ...
    private fun initializeView() {
        ...
        if (!Utils.checkInternetConnection(requireActivity())) {
            Utils.setToast(requireActivity(), getString(com.zila.storelastmile.R.string.network_error))
        } else {
            fetchAllTripIDs()
        }
    ...
    private fun setupActionBar() {
        val drawer = requireActivity().findViewById<DrawerLayout>(com.zila.storelastmile.R.id.container)
        val toolbar = requireActivity().findViewById<Toolbar>(com.zila.storelastmile.R.id.toolbar)
        val layout = requireActivity().findViewById<RelativeLayout>(com.zila.storelastmile.R.id.titlebar)
        val linearLayout = requireActivity().findViewById<LinearLayout>(com.zila.storelastmile.R.id.ll_oder_id_view)
        val titleTextView = requireActivity().findViewById<TextView>(com.zila.storelastmile.R.id.toolbar_title)
        val startTimerButton = requireActivity().findViewById<TextView>(com.zila.storelastmile.R.id.start_timer)
        val assignmentIdTextView = requireActivity().findViewById<TextView>(com.zila.storelastmile.R.id.assignmentid)
        val timerTextView = requireActivity().findViewById<TextView>(com.zila.storelastmile.R.id.tv_timmer)
        val historyTextView = requireActivity().findViewById<TextView>(com.zila.storelastmile.R.id.tv_history)
        ...
        MainActivity.myTripView?.apply {
            setTextColor(ContextCompat.getColor(requireContext(), com.zila.storelastmile.R.color.Black))
            setBackgroundResource(0)
            setTextSize(TypedValue.COMPLEX_UNIT_PX, resources.getDimension(com.zila.storelastmile.R.dimen.font_size_18))
        }
