...
import com.zila.storelastmile.databinding.BottomPopupViewBinding
...
import com.zila.storelastmile.databinding.FragmentMytripListBinding
import com.zila.storelastmile.listener.MyPopupViewListener
import com.zila.storelastmile.listener.SearchMyTripInterface
import com.zila.storelastmile.listener.orderdetailClick
...
import com.zila.storelastmile.ui.views.main.MyTripActivity.Companion.setInterface
import com.zila.storelastmile.ui.views.viewmodels.MyTripViewModel
...
class MyTripListViewFragment : Fragment(), orderdetailClick, MyPopupViewListener, SearchMyTripInterface, Listener {
        ...
        when (apiResponse.status) {
            ...
            Status.SUCCESS -> {
                ...
                if (status) {
                    ...
                    com.zila.storelastmile.utilities.ProgressDialog.getInstance().dismiss()
    ...
    private fun GenerateOTPofSalesPersonforReattempt(apiResponse: ApiResponse) {
        when (apiResponse.status) {
            Status.LOADING -> {
                mBinding!!.proRelatedItem.visibility = View.VISIBLE
                com.zila.storelastmile.utilities.ProgressDialog.getInstance().show(requireActivity())
            }
