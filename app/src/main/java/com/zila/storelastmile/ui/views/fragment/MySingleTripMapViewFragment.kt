...
import com.zila.storelastmile.data.model.*
import com.zila.storelastmile.data.model.MyTripMapOrderResponseModel.CustomerListDc
import com.zila.storelastmile.databinding.CancelReasonBinding
import com.zila.storelastmile.databinding.FragmentSingleTripMapViewBinding
import com.zila.storelastmile.databinding.ShopImageUploadPopupBinding
import com.zila.storelastmile.databinding.TripCompletedPopupBinding
import com.zila.storelastmile.listener.SubmitClick
import com.zila.storelastmile.ui.views.adapter.EntireRouteAdapter
import com.zila.storelastmile.ui.views.adapter.TripCompleteAdapter
import com.zila.storelastmile.ui.views.fragment.unloadReturnItem.OrderDetailReturnActivity
import com.zila.storelastmile.ui.views.main.*
import com.zila.storelastmile.ui.views.viewmodels.MySingleTripMapViewModel
...
class MySingleTripMapViewFragment : Fragment(), OnMapReadyCallback, DirectionsJSONParserNew.directionDuraction, SubmitClick {
    ...
    private fun initViews() {
        ...
        if (!com.zila.storelastmile.utilities.TextUtils.isNullOrEmpty(voiceNoteString)) {
        ...
        mBinding!!.coordinateLayout.tvCalling.setOnClickListener { view: View? ->
            if (!com.zila.storelastmile.utilities.TextUtils.isNullOrEmpty(
                ...
                try {
                    ...
                    if(orderResponseModel!=null){
                        if(orderResponseModel!!.customerOrderinfoDc!=null){
                            ...
                            if (!com.zila.storelastmile.utilities.TextUtils.isNullOrEmpty(orderResponseModel!!.getCustomerOrderinfoDc().shippingAddress)) {
